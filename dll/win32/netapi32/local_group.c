    ...
    PDWORD_PTR resumehandle)
{
    ...
    LPVOID Buffer = NULL;
    PLOCALGROUP_MEMBERS_INFO_0 MembersInfo0 = NULL;
    PLOCALGROUP_MEMBERS_INFO_1 MembersInfo1 = NULL;
    PLOCALGROUP_MEMBERS_INFO_2 MembersInfo2 = NULL;
    PLOCALGROUP_MEMBERS_INFO_3 MembersInfo3 = NULL;
    LPWSTR Ptr = NULL;
    ULONG Size = 0;
    ULONG SidLength;
    ULONG i;
