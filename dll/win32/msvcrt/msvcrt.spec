...
@ cdecl -arch=x86_64,arm,arm64 _chgsignf(long)
...
@ cdecl -arch=x86_64,arm,arm64 _copysignf(long long)
...
@ cdecl -arch=x86_64,arm,arm64 __intrinsic_setjmpex(ptr ptr) _setjmpex
...
@ cdecl abs(long)
@ cdecl acos(double)
@ cdecl -arch=x86_64,arm,arm64 acosf(long)
@ cdecl asctime(ptr)
@ cdecl -version=0x600+ asctime_s(ptr long ptr)
@ cdecl asin(double)
@ cdecl -arch=x86_64,arm,arm64 asinf(long)
@ cdecl atan(double)
@ cdecl atan2(double double)
@ cdecl -arch=x86_64,arm,arm64 atan2f(long)
@ cdecl -arch=x86_64,arm,arm64 atanf(long)
...
@ cdecl ceil(double)
@ cdecl -arch=x86_64,arm,arm64 ceilf(long)
@ cdecl clearerr(ptr)
@ stub -version=0x600+ clearerr_s
@ cdecl clock()
@ cdecl cos(double)
@ cdecl -arch=x86_64,arm,arm64 cosf(long)
@ cdecl cosh(double)
@ cdecl -arch=x86_64,arm,arm64 coshf(long)
@ cdecl ctime(ptr)
...
@ cdecl floor(double)
@ cdecl -arch=x86_64,arm,arm64 floorf(long)
@ cdecl fmod(double double)
@ cdecl -arch=x86_64,arm,arm64 fmodf(long)
@ cdecl fopen(str str)
...
@ cdecl -arch=x86_64,arm,arm64 logf(long)
...
@ cdecl -arch=x86_64,arm,arm64 modff(long ptr)
@ cdecl perror(str)
@ cdecl pow(double double)
@ cdecl -arch=x86_64,arm,arm64 powf(long)
@ varargs printf(str)
...
@ cdecl -arch=x86_64,arm,arm64 -norelay setjmp(ptr ptr) _setjmp
@ cdecl setlocale(long str)
@ cdecl setvbuf(ptr str long long)
@ cdecl signal(long long)
@ cdecl sin(double)
@ cdecl -arch=x86_64,arm,arm64 sinf(long)
@ cdecl sinh(double)
@ cdecl -arch=x86_64,arm,arm64 sinhf(long)
@ varargs sprintf(ptr str)
@ varargs -version=0x600+ sprintf_s(ptr long str)
@ cdecl sqrt(double)
@ cdecl -arch=x86_64,arm,arm64 sqrtf(long)
@ cdecl srand(long)
...
@ cdecl system(str)
@ cdecl tan(double)
@ cdecl -arch=x86_64,arm,arm64 tanf(long)
@ cdecl tanh(double)
@ cdecl -arch=x86_64,arm,arm64 tanhf(long)
@ cdecl time(ptr)
@ cdecl tmpfile()
...
@ cdecl wcstoll(wstr ptr long)
@ cdecl wcstombs(ptr ptr long)
@ stub -version=0x600+ wcstombs_s
@ cdecl wcstoul(wstr ptr long)
@ cdecl wcstoull(wstr ptr long)
