...
if(NOT TOOLCHAIN_PATH)
    if(DEFINED ENV{ROS_TOOLCHAIN_PATH})
        ...
        if(ARCH STREQUAL "arm64" OR ARCH STREQUAL "aarch64")
            set(TOOLCHAIN_PATH "/home/ahmed/x-tools/aarch64-w64-mingw32/bin" CACHE PATH "Path to toolchain binaries" FORCE)
        ...
        elseif(ARCH STREQUAL "i386" OR ARCH STREQUAL "x86")
            set(TOOLCHAIN_PATH "/home/ahmed/x-tools/i686-w64-mingw32/bin" CACHE PATH "Path to toolchain binaries" FORCE)
        else()
            set(TOOLCHAIN_PATH "/home/ahmed/x-tools/x86_64-w64-mingw32/bin" CACHE PATH "Path to toolchain binaries" FORCE)
        endif()
    endif()
