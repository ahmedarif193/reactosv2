...
@ stdcall -arch=i386,arm,arm64 HalBeginSystemInterrupt(long long ptr)
...
@ stdcall -arch=i386,arm,arm64 HalEndSystemInterrupt(long long)
...
@ stdcall -arch=arm64 HalQueryArm64TimerConfig(ptr)
...
@ fastcall -arch=arm,arm64 HalSweepIcache()
@ fastcall -arch=arm,arm64 HalSweepDcache()
@ fastcall HalSystemVectorDispatchEntry(long long long)
@ stdcall HalTranslateBusAddress(long long long long ptr ptr)
@ stdcall -arch=i386,x86_64,arm64 HalIsPciMsiSupported()
@ stdcall -arch=arm64 HalGetMsiMessageAddress(long long long long ptr ptr ptr)
@ stdcall -arch=arm64 HalGetMsiMessageAddressEx(long long long long long ptr ptr ptr)
@ stdcall -arch=arm64 HalGetMsiVectorRange(ptr ptr)
@ stdcall -arch=i386,x86_64,arm64 HalQueryPciMsiSupport(long long ptr ptr ptr ptr ptr)
@ stdcall -arch=i386,x86_64,arm64 HalpRecordPciMaxGsi(ptr)
