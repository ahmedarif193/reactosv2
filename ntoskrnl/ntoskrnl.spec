...
@ cdecl -arch=arm64 __C_specific_handler(ptr ptr ptr ptr)
...
@ stdcall -arch=x86_64,arm,arm64 ExQueryDepthSList(ptr) RtlQueryDepthSList
...
@ fastcall -arch=arm64 KfLowerIrql(long)
@ fastcall -arch=arm64 KfRaiseIrql(long)
...
@ stdcall PoRegisterProcessorIdleHandler(long ptr long)
@ stdcall PoNotifyProcessorThermalEvent(long long long)
@ stdcall PoRegisterDeviceNotify(ptr long long long ptr ptr)
@ stdcall PoRegisterSystemState(ptr long)
@ stdcall PoUnregisterProcessorIdleHandler(long)
...
@ stdcall -arch=x86_64 PsIsWow64Process(ptr)
@ stdcall -arch=x86_64 PsIsWow64Thread(ptr)
...
@ stdcall -arch=x86_64,arm,arm64 RtlUnwindEx(ptr ptr ptr ptr ptr ptr)
