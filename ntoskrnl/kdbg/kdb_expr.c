...
static const struct
{
    PCHAR Name;
#if defined(_M_ARM64)
    USHORT Offset;  /* ARM64 KTRAP_FRAME has offsets > 255 */
    USHORT Size;
#else
    UCHAR Offset;
    UCHAR Size;
...
RegisterToTrapFrame[] =
{
    ...
    /* ARM64 registers - uses CONTEXT structure directly */
    ...
    {"x4",      FIELD_OFFSET(KDB_KTRAP_FRAME, X4),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X4)},
    {"x5",      FIELD_OFFSET(KDB_KTRAP_FRAME, X5),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X5)},
    {"x6",      FIELD_OFFSET(KDB_KTRAP_FRAME, X6),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X6)},
    {"x7",      FIELD_OFFSET(KDB_KTRAP_FRAME, X7),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X7)},
    {"x8",      FIELD_OFFSET(KDB_KTRAP_FRAME, X8),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X8)},
    {"x9",      FIELD_OFFSET(KDB_KTRAP_FRAME, X9),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X9)},
    {"x10",     FIELD_OFFSET(KDB_KTRAP_FRAME, X10),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X10)},
    {"x11",     FIELD_OFFSET(KDB_KTRAP_FRAME, X11),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X11)},
    {"x12",     FIELD_OFFSET(KDB_KTRAP_FRAME, X12),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X12)},
    {"x13",     FIELD_OFFSET(KDB_KTRAP_FRAME, X13),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X13)},
    {"x14",     FIELD_OFFSET(KDB_KTRAP_FRAME, X14),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X14)},
    {"x15",     FIELD_OFFSET(KDB_KTRAP_FRAME, X15),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X15)},
    {"x16",     FIELD_OFFSET(KDB_KTRAP_FRAME, X16),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X16)},
    {"x17",     FIELD_OFFSET(KDB_KTRAP_FRAME, X17),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X17)},
    {"x18",     FIELD_OFFSET(KDB_KTRAP_FRAME, X18),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X18)},
    {"x19",     FIELD_OFFSET(KDB_KTRAP_FRAME, X19),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X19)},
    {"x20",     FIELD_OFFSET(KDB_KTRAP_FRAME, X20),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X20)},
    {"x21",     FIELD_OFFSET(KDB_KTRAP_FRAME, X21),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X21)},
    {"x22",     FIELD_OFFSET(KDB_KTRAP_FRAME, X22),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X22)},
    {"x23",     FIELD_OFFSET(KDB_KTRAP_FRAME, X23),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X23)},
    {"x24",     FIELD_OFFSET(KDB_KTRAP_FRAME, X24),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X24)},
    {"x25",     FIELD_OFFSET(KDB_KTRAP_FRAME, X25),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X25)},
    {"x26",     FIELD_OFFSET(KDB_KTRAP_FRAME, X26),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X26)},
    {"x27",     FIELD_OFFSET(KDB_KTRAP_FRAME, X27),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X27)},
    {"x28",     FIELD_OFFSET(KDB_KTRAP_FRAME, X28),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, X28)}
#else
#error "Unsupported architecture for KDB expression evaluator"
#endif
};
