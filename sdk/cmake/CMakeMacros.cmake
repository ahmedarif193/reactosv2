...
function(add_cd_file)
    ...
    if(NOT __cd EQUAL -1)
        ...
        if(_CD_NO_CAB)
            ...
            endforeach()
            # manage dependency
            if(_CD_TARGET AND TARGET bootcd)
            ...
            if(_CD_TARGET AND TARGET reactos_cab_inf)
    ...
    if(NOT __cd EQUAL -1)
        # manage dependency
        if(_CD_TARGET AND TARGET livecd)
    ...
    if(NOT __cd EQUAL -1)
        # manage dependency
        if(_CD_TARGET AND TARGET hybridcd)
...
function(set_module_type MODULE TYPE)
    ...
    elseif(${TYPE} STREQUAL nativecui)
        ...
        if(ARCH STREQUAL "i386")
            ...
            set_entrypoint(${MODULE} NtProcessStartup)
        endif()
    elseif(${TYPE} STREQUAL win32cui)
        if(__module_UNICODE)
    ...
    elseif(TYPE STREQUAL kernel)
        ...
        if(ARCH STREQUAL "i386")
            ...
            set_entrypoint(${MODULE} KiSystemStartup)
        endif()
