...
if(NOT MSVC)
    ...
    # Run ranlib to add index after dlltool for amd64, i386, and arm64
    ...
    # Ensure the final library has an index for amd64, i386, and arm64
    ...
    if(ARCH STREQUAL "amd64" OR ARCH STREQUAL "i386" OR ARCH STREQUAL "arm64")
        add_custom_command(TARGET oldnames POST_BUILD
            ...
            COMMENT "Overwriting oldnames with proper library index (amd64/i386/arm64 workaround)")
    endif()
else()
