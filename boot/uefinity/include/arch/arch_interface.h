...
typedef struct _ARCH_INTERFACE {
    ...
    EFI_STATUS (*ArchDetectCPU)(PARCH_CPU_INFO CpuInfo);
    ...
    /* Common hooks to keep common code ifdef-free */
    const CHAR* (*ArchGetSystemFamilyString)(VOID);
    VOID (*ArchDetectAcpi)(PCONFIGURATION_COMPONENT_DATA SystemKey, ULONG *BusNumber);
