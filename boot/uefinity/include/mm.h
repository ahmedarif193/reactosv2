...
#define MM_PAGE_MASK    0xFFF
#define MM_PAGE_SHIFT    12
/* Conservative limits for loader environment */
#define MM_MAX_PAGE        0x1FFFFF
#define MM_MAX_PAGE_LOADER 0x3FFFF
...
VOID MmFreePagesInLookupTable(PVOID PageLookupTable, PFN_NUMBER StartPage, PFN_NUMBER PageCount);
...
ULONG AddMemoryDescriptor(PFREELDR_MEMORY_DESCRIPTOR List, ULONG MaxCount, PFN_NUMBER BasePage, PFN_NUMBER PageCount, TYPE_OF_MEMORY MemoryType);
