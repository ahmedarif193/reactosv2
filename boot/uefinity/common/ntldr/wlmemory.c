...
MempAddMemoryBlock(IN OUT PLOADER_PARAMETER_BLOCK LoaderBlock,
                   ...
                   ULONG Type)
{
    TRACE("MempAddMemoryBlock(BasePage=0x%I64x, PageCount=0x%I64x, Type=%ld)\n",
          (unsigned long long)(ULONG_PTR)BasePage,
    ...
    ULONG Type)
{
    ...
    TRACE("MempSetupPagingForRegion(BasePage=0x%I64x, PageCount=0x%I64x, Type=%ld)\n",
          (unsigned long long)(ULONG_PTR)BasePage,
          (unsigned long long)(ULONG_PTR)PageCount,
          Type);
