    ...
    _In_ PCSTR LogName)
{
    ...
    RtlCopyMemory(HiveBaseBlock, LogBaseBlock, LogBaseBlock->Cluster * HSECTOR_SIZE);
    ...
    _Out_opt_ PHKEY SubKey)
{
    ...
    else
    {
        ...
        /* Normal name */
        RtlCopyMemory(Name, SubKeyNode->Name, min(*NameSize, SubKeyNode->NameLength));
    }
    ...
    _Inout_opt_ PULONG DataSize)
{
    ...
    if (DataSize != NULL)
    {
        ...
        {
            RtlCopyMemory(Data, DataCell, min(*DataSize, DataLength));
        }
    ...
    _Inout_opt_ PULONG DataSize)
{
    ...
    else
    {
        ...
        /* Normal name */
        RtlCopyMemory(ValueName, ValueCell->Name, min(*NameSize, ValueCell->NameLength));
    }
