    ...
    _In_ PCSTR CmdLine)
{
    ...
    TRACE("[SETTINGS] CmdLineParse input: '%s'\n", CmdLine ? CmdLine : "<null>");
    ...
    if (Setting)
    {
        ...
        TRACE("[SETTINGS] Debug string (cmdline): '%s'\n", DebugString);
    }
    ...
    if (Setting)
    {
        ...
        TRACE("[SETTINGS] Timeout (cmdline): %ld\n", BootMgrInfo.TimeOut);
    }
    ...
    if (Setting)
    {
        ...
        TRACE("[SETTINGS] DefaultOS (cmdline): '%s'\n", DefaultOs);
    }
    ...
    _In_opt_ PCSTR CmdLine)
{
    ...
    {
        BootMgrInfo.DebugString = DebugString;
        TRACE("[SETTINGS] Debug string (freeldr.ini): '%s'\n", DebugString);
    }
    ...
    if (BootMgrInfo.TimeOut < 0)
    {
                                 ...
                                 TimeOutText, sizeof(TimeOutText)))
        {
            ...
            TRACE("[SETTINGS] Timeout (freeldr.ini): %ld\n", BootMgrInfo.TimeOut);
        }
    }
    ...
    if (!BootMgrInfo.DefaultOs || !*BootMgrInfo.DefaultOs)
    {
        ...
        {
            BootMgrInfo.DefaultOs = DefaultOs;
            TRACE("[SETTINGS] DefaultOS (freeldr.ini): '%s'\n", DefaultOs);
        }
    }
}
