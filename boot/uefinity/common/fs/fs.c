...
{
    IsoMount,      // ISO9660 - now enabled for ARM64
    FatMount,      // FAT32 - always supported
    BtrFsMount,    // BTRFS - always supported
    NtfsMount,     // NTFS - now enabled for ARM64
    ExtMount,      // EXT2/3/4 - now enabled for ARM64
#if defined(_M_IX86) || defined(_M_AMD64)
#ifndef UEFIBOOT
    PxeMount,      // PXE - only for x86/AMD64 non-UEFI
#endif
#endif
};
